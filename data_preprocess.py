...
import copy
# 数据预处理
df = {'3': pd.read_csv('./psnr3_ori.csv').to_numpy(), '4': [], '5': [], '6': [],
      '7': pd.read_csv('./psnr7_ori.csv').to_numpy(),'3_':[],'7_':[]}
num = 0
for line_3 in df['3']:
    num += 1
    print(num)
